/**
 * WS7 COPY of tests/helpers/netClock.js until WS2's src/net/clock.js lands (parity-tested).
 *
 * Original header: TEMPORARY clock-offset estimator standing in for WS2's src/net/clock.js `createClockSync` until it lands
