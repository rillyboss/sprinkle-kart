/**
 * WS7 COPY of tests/helpers/netWire.js, so the running game speaks the NETWORKING.md §5/§6 wire until WS2
 * lands. Byte-for-byte the same encoder/decoder as the test helper (tests/net.integration.standins.test.js
 * checks parity). When WS2 merges: delete this file and point src/online/stack.js at WS2's modules.
 *
 * Original header: TEMPORARY wire stand-in for WS2 (src/net/{codec,messages,enums,frag}.js), used by the WS5 netcode tests
 ...
 */
import { ITEM_ORDER } from '../../race/itemCatalog.js';
