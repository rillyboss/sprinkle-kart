...
/** Game modes. 'free' = the original single race; 'team' = Team Race; 'battle' = Bubble Pop Battle; 'daily' = Daily Sprinkle; 'tutorial' = How to Play practice. */
export const MODES = Object.freeze(['free', 'grand-prix', 'time-trial', 'team', 'battle', 'daily', 'tutorial']);
