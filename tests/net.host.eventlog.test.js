...
describe('event log', () => {
  ...
  it('builds every catalogue payload with ids and ms timings', () => {
    ...
    const cases = [
      ...
      [{ type: 'hop', kart: k }, {}],
      [{ type: 'land', kart: k, strength: 0.4 }, { strength: 0.4, air: false, trick: false }],
      [{ type: 'land', kart: k, strength: 0.9, air: true, trick: true, airTime: 0.8 }, { strength: 0.9, air: true, trick: true }],
      [{ type: 'boost', kart: k, source: 'trick' }, { source: 'trick' }],
      [{ type: 'boost', kart: k, source: 'ring' }, { source: 'ring' }],
      [{ type: 'launch', kart: k, jump: 2, vy: 9 }, { jump: 2 }],
      [{ type: 'trick', kart: k, kind: 3 }, { kind: 3 }],
      [{ type: 'ring', kart: k, ring: 1 }, { ring: 1 }],
