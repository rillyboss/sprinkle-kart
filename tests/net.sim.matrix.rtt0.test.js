// Convergence matrix, Free Race, RTT 0 ms (NETWORKING.md §15, acceptance M1-6 / M1-7 / M1-8, WS5 #1-3):
...
describe('convergence matrix: Free Race at 0 ms RTT', () => {
  it('all 16 cells converge', () => {
    const row = runMatrixRow(0);
