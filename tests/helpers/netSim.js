/**
 * TEMPORARY sim hooks for the WS5 netcode tests until WS1 PR (a) lands (NETWORKING.md §8.4, §8.5):
...
import { stepKart, giveBoost, constrainToTrack } from '../../src/race/Kart.js';
